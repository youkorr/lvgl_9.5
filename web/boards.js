...
window.BOARDS = [
  ...
  { id: "esp32-p4-function-ev", brand: "Espressif", name: "ESP32-P4 Function EV", chip: "esp32-p4",   flash: "16MB", psram: "32MB",   framework: "esp-idf", tag: "Flagship" },
  ...
  { id: "ws-esp32-p4-nano",        brand: "Waveshare", name: "ESP32-P4 Nano",        chip: "esp32-p4",  flash: "16MB", psram: "32MB",   framework: "esp-idf", tag: "MIPI-DSI" },
  { id: "ws-esp32-p4-86-panel",    brand: "Waveshare", name: "ESP32-P4 86 Panel",    chip: "esp32-p4",  flash: "16MB", psram: "32MB",   framework: "esp-idf", tag: "" },
  ...
  { id: "generic-esp32-p4-n16r32",brand:"Generic",name: "ESP32-P4 N16R32",       chip: "esp32-p4",    flash: "16MB", psram: "32MB",   framework: "esp-idf", tag: "Bare" },
];
...
window.BOARD_TEMPLATE = function(b, opts) {
  const dev = opts && opts.esphomeBranch === "dev";
  // ESPHome stable/dev is selected at install time by the compile workflow.
  // We just leave a marker comment so the user knows which branch will be used.
